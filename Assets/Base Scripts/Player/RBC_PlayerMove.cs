...
public class RBC_PlayerMove : MonoBehaviour
{
        ...
        private void Start()
    {
        ...
        //mobile UI Aim button
        Button btnMA = AimBtn.GetComponent<Button>();
        btnMA.onClick.AddListener(MobileAim);
        //mobile UI Shoot button
        Button btnMS = ShootBtn.GetComponent<Button>();
        btnMS.onClick.AddListener(MobileShoot);
    }
