...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        // parkour freefall fix
        public bool landedfromparkour = false;
        ...
        private void CameraRotation()
        {
            ...
            // Rotate the objectToRotate along with the camera
            if (objectToRotate != null)
            {
                objectToRotate.transform.rotation = CinemachineCameraTarget.transform.rotation;
            }
        }
        ...
        private void Move()
        {
            ...
            // iStep Gravity work only when character controller is enabled
            if (playerControl) 
            {
        ...
        private void JumpAndGravity()
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (_hasAnimator)
                    {
                        if (landedfromparkour) 
                        {
                            _animator.SetBool(_animIDFreeFall, false);
                            landedfromparkour = !landedfromparkour;
                        } 
                        else 
                        {
        ...
        {
            // the square root of H * -2 * G = how much velocity needed to reach desired height
            _verticalVelocity = Mathf.Sqrt(15 * -2f * Gravity);
        }
