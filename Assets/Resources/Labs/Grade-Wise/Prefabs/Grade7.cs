...
public class Grade7 : MonoBehaviour
{
    ...
    public void gotoClass()
    {
        ...
        if (accesibleClasses.Contains("7") ) {                                       //CHANGE "->  <-"

            //Call Respective subjects in Chapters-UI 
            mainPlayer.GetComponent<LabRoomManager>().SevenClassChapterLab();                    //CHANGE METHOD-NAME()

        }
        else if (responseText.Contains("all"))
        {
            //Call Respective subjects in Chapters-UI 
            mainPlayer.GetComponent<LabRoomManager>().SevenClassChapterLab();
        }
        else
        {
